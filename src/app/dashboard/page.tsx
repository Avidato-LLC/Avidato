      ...
      <div className="p-6 lg:p-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="bg-gradient-to-br from-indigo-500 to-purple-600 rounded-xl p-8 text-white">
            ...
            <button className="bg-white text-indigo-600 font-semibold px-6 py-3 rounded-lg hover:bg-indigo-50 transition-colors">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-8">
            ...
            <div className="text-center py-8">
              ...
              <p className="mt-2 text-gray-500 dark:text-gray-400">No activity yet</p>
              <p className="text-sm text-gray-400 dark:text-gray-500">Your recent lessons and students will appear here</p>
            </div>
          </div>
        </div>
